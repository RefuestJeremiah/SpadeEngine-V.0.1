	...
	public function new(script:String) {
		...
		Lua_helper.add_callback(lua, "keyJustPressed", function(name:String) {
			...
			switch(name) {
				...
				case 'extra1': key = (PlayState.instance.getControl('EXTRA1_P') || FlxG.keys.justPressed.SHIFT);//an extra key for convinience
				case 'extra2': key = (PlayState.instance.getControl('EXTRA2_P') || FlxG.keys.justPressed.Q);//an extra key for convinience
				case 'extra3': key = (PlayState.instance.getControl('EXTRA3_P') || FlxG.keys.justPressed.E);//an extra key for convinience
				case 'extra4': key = (PlayState.instance.getControl('EXTRA4_P') || FlxG.keys.justPressed.SPACE);//an extra key for convinience
			}
			return key;
		});
		Lua_helper.add_callback(lua, "keyPressed", function(name:String) {
			...
			switch(name) {
				...
				case 'extra1': key = (PlayState.instance.getControl('EXTRA1') || FlxG.keys.pressed.SHIFT);//an extra key for convinience
				case 'extra2': key = (PlayState.instance.getControl('EXTRA2') || FlxG.keys.pressed.Q);//an extra key for convinience
				case 'extra3': key = (PlayState.instance.getControl('EXTRA3') || FlxG.keys.pressed.E);//an extra key for convinience
				case 'extra4': key = (PlayState.instance.getControl('EXTRA4') || FlxG.keys.pressed.SPACE);//an extra key for convinience
			}
			return key;
		});
		Lua_helper.add_callback(lua, "keyReleased", function(name:String) {
			...
			switch(name) {
				...
				case 'extra1': key = (PlayState.instance.getControl('SHIFT_R') || FlxG.keys.justReleased.SHIFT);//an extra key for convinience
				case 'extra2': key = (PlayState.instance.getControl('RSHIFT_R') || FlxG.keys.justReleased.RSHIFT);//an extra key for convinience
				case 'extra3': key = (PlayState.instance.getControl('LSHIFT_R') || FlxG.keys.justReleased.LSHIFT);//an extra key for convinience
				case 'extra4': key = (PlayState.instance.getControl('SPACE_R') || FlxG.keys.justReleased.SPACE);//an extra key for convinience
			}
			return key;
		});
